...
final_table_tpm_ctrls <- handle_tpm_salmon_output('/scratch/erikzhi/ENCODE_data/salmon_output/controls', unique(target_ctrl_files), target_genes, gencode_v36)
final_table_tpm_perts <- handle_tpm_salmon_output('/scratch/erikzhi/ENCODE_data/salmon_output/experiments', unique(target_pert_files), target_genes, gencode_v36)
