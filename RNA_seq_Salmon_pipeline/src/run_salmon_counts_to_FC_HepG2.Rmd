...
final_table_tpm_ctrls <- handle_tpm_salmon_output('/scratch/erikzhi/ENCODE_data_HepG2/salmon_output/controls', unique(target_ctrl_files), target_genes, gencode_v37)
final_table_tpm_perts <- handle_tpm_salmon_output('/scratch/erikzhi/ENCODE_data_HepG2/salmon_output/experiments', unique(target_pert_files), target_genes, gencode_v37)
